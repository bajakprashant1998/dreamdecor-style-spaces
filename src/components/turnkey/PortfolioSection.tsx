              ...
              <Card className="overflow-hidden border-none shadow-md group h-full">
                <div className="relative aspect-[4/3] overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                    <Button variant="secondary" size="icon" className="rounded-full" tabIndex={-1}>
                      <Maximize2 className="h-5 w-5" />
                    </Button>
                  </div>
                  <div className="absolute top-4 left-4">
                    <Badge variant="secondary" className="bg-background/90 text-foreground hover:bg-background">
                      {project.type}
                    </Badge>
                  </div>
                </div>
                ...
                <CardFooter className="p-6 pt-0">
                  <Button variant="link" className="p-0 h-auto font-semibold text-primary" tabIndex={-1}>

      ...
      <div className="container relative z-10 flex h-full flex-col justify-center px-4 md:px-6">
        ...
        >
          ...
          <h1 className="text-4xl font-bold leading-tight tracking-tight sm:text-5xl md:text-6xl lg:text-7xl">
            Turnkey Interior <br />
            <span className="text-primary-foreground">By Dream Decor</span>
          </h1>

          <p className="max-w-2xl text-lg text-gray-200 sm:text-xl">
            60% Time Savings & 30% Cost Savings — Complete interior solutions from concept to move-in ready handover with our in-house manufacturing unit.
          </p>
          ...
          <div className="grid grid-cols-2 gap-4 pt-8 text-sm sm:grid-cols-4 sm:text-base">
            <div className="flex items-center gap-2">
              <CheckCircle2 className="h-5 w-5 text-green-400" />
              <span>1,00,000+ Products</span>
            </div>
            <div className="flex items-center gap-2">
              <CheckCircle2 className="h-5 w-5 text-green-400" />
              <span>1100+ Projects</span>
            </div>
            <div className="flex items-center gap-2">
              <CheckCircle2 className="h-5 w-5 text-green-400" />
              <span>5,00,000+ Customers</span>
            </div>
            <div className="flex items-center gap-2">
              <CheckCircle2 className="h-5 w-5 text-green-400" />
